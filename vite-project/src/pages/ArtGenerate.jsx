      ...
      {isAuth ? (
       ...
       <>
        ...
        <p className={classes.loginPls}>
          Welcome! Log in or register to join our community of creative people.
          If you don't want to register right now, you can view the gallery of
